...
// Embedded, nullable, 1:1 with pcr_version (design doc §3) — kept per-defendant rather than
// promoted to pcr_case_hearing, since which offence's nextHearing wins is still unconfirmed.
@Embeddable
@Getter
