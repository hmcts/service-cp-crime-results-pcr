CREATE TABLE cp_judicial_result (
    id uuid PRIMARY KEY NOT NULL,
    offence_id uuid REFERENCES cp_offence(id) ON DELETE CASCADE,
...
CREATE INDEX idx_cp_judicial_result_offence ON cp_judicial_result (offence_id);
CREATE INDEX idx_cp_judicial_result_court_application ON cp_judicial_result (court_application_id);