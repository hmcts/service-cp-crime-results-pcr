...
-- cases -- cp_case_hearing.case_urn now resolves to one real case URN (the first linked case)
...
CREATE TABLE cp_case_hearing_linked_case (
    id uuid PRIMARY KEY NOT NULL,
    case_hearing_id uuid NOT NULL REFERENCES cp_case_hearing(id) ON DELETE CASCADE,
    case_urn varchar NOT NULL
);

CREATE INDEX idx_cp_case_hearing_linked_case_case_hearing ON cp_case_hearing_linked_case (case_hearing_id);
