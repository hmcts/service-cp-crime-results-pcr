...
class PcrOrchestratorTest {

    private final PcrOrchestrator pcrOrchestrator = new PcrOrchestrator();
    ...
    void excludePublishedForNows_should_removeResultsMarkedPublishedForNows() {
        ...
        final List<JudicialResult> result = pcrOrchestrator.excludePublishedForNows(List.of(published, eligible));
    ...
    void excludePublishedForNows_should_returnEmptyList_whenAllResultsPublishedForNows() {
        ...
        final List<JudicialResult> result = pcrOrchestrator.excludePublishedForNows(List.of(published));
