...
class PcrCourtApplicationRepositoryTest extends RepositoryIntegrationTestBase {
    ...
    @Autowired
    private PcrCourtApplicationRepository pcrCourtApplicationRepository;

    @Test
    void save_should_persistAndReturnEveryField_whenFindById() {
        saveParents();

        final PcrCourtApplicationEntity entity = PcrCourtApplicationEntity.builder()
        ...
        final Optional<PcrCourtApplicationEntity> found = pcrCourtApplicationRepository.findById(COURT_APPLICATION_ID);
