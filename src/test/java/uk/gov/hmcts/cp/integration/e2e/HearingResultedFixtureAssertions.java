...
abstract class HearingResultedFixtureAssertions extends IngestionE2ETestBase {

    protected static final UUID HEARING_ID = UUID.fromString("5f75863f-270a-482a-9e67-eaccb2fd3130");
    protected static final String HEARING_DAY = "2026-07-23";
    protected static final String CASE_URN = "TEST1234567";
    protected static final UUID DEFENDANT_ID = UUID.fromString("ea6b2d84-e99a-47ff-b031-a036e093f627");
    ...
    private static final String EVENT_FIXTURE_PATH = "events/hearing-resulted-event.json";
    private static final String CACHE_KEY = "INT_" + HEARING_ID + "_" + HEARING_DAY + "_result_";

    @Autowired
    protected StringRedisTemplate redisTemplate;
    @Autowired
    protected CPCaseHearingRepository caseHearingRepository;
    @Autowired
    protected CPVersionRepository versionRepository;
    @Autowired
    protected CPCourtApplicationRepository courtApplicationRepository;
    @Autowired
    protected CPOffenceRepository offenceRepository;
    @Autowired
    protected CPJudicialResultRepository judicialResultRepository;
    @Autowired
    protected CPJudicialResultPromptRepository judicialResultPromptRepository;

    private WireMockServer wireMockServer;
    protected CPCaseHearingEntity caseHearing;
    protected CPVersionEntity version;
    protected CPJudicialResultEntity imprisonment;

    @BeforeEach
    void beforeEachFixture() {
    ...
    protected void given_a_matching_prison_court_register_subscription() {
    ...
    protected void given_the_real_hearing_payload_is_seeded_in_redis() {
        redisTemplate.opsForValue().set(CACHE_KEY, readResourceContents(FIXTURE_PATH));
    }

    protected void then_the_case_hearing_is_persisted() {
    ...
    protected void then_the_version_is_persisted_with_defendant_pii_and_custody() {
    ...
    protected void then_the_court_application_is_persisted() {
    ...
    protected void then_the_offence_and_judicial_result_are_persisted() {
    ...
    protected void then_the_judicial_result_prompts_are_persisted() {
    ...
    protected void then_the_get_pcr_query_returns_the_persisted_result() throws Exception {
    ...
    protected String hearingResultedEvent() {
        return readResourceContents(EVENT_FIXTURE_PATH)
